...
exports.triggerEvents = function (event, document, events, collection, db, options) {
            ...
            Utils.iterateArrayWithPromise(updatedFieldDoc,
                function (docIndex, nestedDoc) {
                    ...
                    if (nestedDoc.type == "insert") {
                        ...
                        return Self.triggerEvents("onInsert", nestedDoc, events,collection, db, nestedOptions);
                        ...
                        return Self.triggerEvents("onValue", nestedDoc, events, collection,db, nestedOptions);
